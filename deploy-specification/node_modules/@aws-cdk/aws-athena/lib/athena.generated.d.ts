...
export declare class CfnDataCatalog extends cdk.CfnResource implements cdk.IInspectable {
     ...
     * @internal
     */
    static _fromCloudFormation(scope: cdk.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnDataCatalog;
    /**
     * `AWS::Athena::DataCatalog.Name`.
     *
     * @external
     ...
     * @external
     */
    constructor(scope: cdk.Construct, id: string, props: CfnDataCatalogProps);
    /**
...
export declare class CfnNamedQuery extends cdk.CfnResource implements cdk.IInspectable {
     ...
     * @internal
     */
    static _fromCloudFormation(scope: cdk.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnNamedQuery;
    /**
     * @external
...
export interface CfnWorkGroupProps {
     ...
     */
    readonly workGroupConfigurationUpdates?: CfnWorkGroup.WorkGroupConfigurationUpdatesProperty | cdk.IResolvable;
}
/**
...
export declare class CfnWorkGroup extends cdk.CfnResource implements cdk.IInspectable {
     ...
     * @internal
     */
    static _fromCloudFormation(scope: cdk.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnWorkGroup;
    /**
     * @external
     ...
     */
    readonly attrEffectiveEngineVersion: string;
    /**
     * `AWS::Athena::WorkGroup.Name`.
     *
     * @external
     ...
     * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-athena-workgroup.html#cfn-athena-workgroup-workgroupconfigurationupdates
     */
    workGroupConfigurationUpdates: CfnWorkGroup.WorkGroupConfigurationUpdatesProperty | cdk.IResolvable | undefined;
    /**
     ...
     * @external
     */
    constructor(scope: cdk.Construct, id: string, props: CfnWorkGroupProps);
    /**
     * (experimental) Examines the CloudFormation resource and discloses attributes.
     *
     * @param inspector - tree inspector to collect and process attributes.
