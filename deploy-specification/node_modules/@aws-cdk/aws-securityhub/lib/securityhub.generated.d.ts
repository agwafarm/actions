...
export declare class CfnHub extends cdk.CfnResource implements cdk.IInspectable {
     ...
     * @internal
     */
    static _fromCloudFormation(scope: cdk.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnHub;
    /**
     * `AWS::SecurityHub::Hub.Tags`.
     *
     * @external
     ...
     * @external
     */
    constructor(scope: cdk.Construct, id: string, props?: CfnHubProps);
    /**
